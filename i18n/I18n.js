...
window.LANG_UI_OVERRIDES = {
	ko: {
		...
		"ui.reasoningTabInsights": "Ý nghĩa bài hát",
		"ui.reasoningTabTranslation": "번역",
		"ui.reasoningTabPhonetic": "발음",
		"ui.preTranslateChip": "다음: {title}",
		"sections.aboutAndUpdates": "정보 및 업데이트",
		"settings.checkForUpdates": "업데이트 확인",
		"settings.updateAppSubtitle": "AI 가사 번역 및 비디오 배경",
		"updateModal.title": "Lyrics Plus 업데이트 사용 가능",
		"updateModal.currentVersion": "현재 버전: v{version}",
		"updateModal.quickUpdate": "빠른 업데이트 (권장)",
		"updateModal.quickUpdateDesc": "PowerShell에서 다음 명령을 실행하여 자동 업데이트:",
		"updateModal.copyCommand": "설치 명령 복사",
		"updateModal.changelog": "변경 로그 보기",
		"updateModal.skipVersion": "이 버전 건너뛰기",
		"updateModal.later": "나중에",
		"notifications.upToDate": "현재 최신 버전(v{version})을 사용하고 있습니다!",
		"notifications.updateAvailable": "Lyrics Plus v{version} 업데이트가 있습니다! 클릭하여 업데이트",
		"notifications.installCommandCopied": "설치 명령이 복사되었습니다! PowerShell에 붙여넣으세요",
		"notifications.updateSkipped": "업데이트를 건너뛰었습니다",
	...
	ja: {
		...
		"sections.aboutAndUpdates": "情報と更新",
		"settings.checkForUpdates": "更新を確認",
		"settings.updateAppSubtitle": "AI歌詞翻訳＆動画背景",
		"updateModal.title": "Lyrics Plus アップデートが利用可能",
		"updateModal.currentVersion": "現在のバージョン: v{version}",
		"updateModal.quickUpdate": "クイックアップデート（推奨）",
		"updateModal.quickUpdateDesc": "PowerShellで次のコマンドを実行して自動更新:",
		"updateModal.copyCommand": "インストールコマンドをコピー",
		"updateModal.changelog": "変更履歴を見る",
		"updateModal.skipVersion": "このバージョンをスキップ",
		"updateModal.later": "後で",
		"notifications.upToDate": "最新バージョン（v{version}）を使用しています！",
		"notifications.updateAvailable": "Lyrics Plus v{version} が利用可能です！クリックして更新",
		"notifications.installCommandCopied": "インストールコマンドをコピーしました！PowerShellに貼り付けてください",
		"notifications.updateSkipped": "更新をスキップしました",
	...
	zh: {
		...
		"sections.aboutAndUpdates": "关于与更新",
		"settings.checkForUpdates": "检查更新",
		"settings.updateAppSubtitle": "AI歌词翻译与视频背景",
		"updateModal.title": "Lyrics Plus 新版本可用",
		"updateModal.currentVersion": "当前版本: v{version}",
		"updateModal.quickUpdate": "快速更新（推荐）",
		"updateModal.quickUpdateDesc": "在PowerShell中运行以下命令以自动更新:",
		"updateModal.copyCommand": "复制安装命令",
		"updateModal.changelog": "查看更新日志",
		"updateModal.skipVersion": "跳过此版本",
		"updateModal.later": "稍后",
		"notifications.upToDate": "你已在使用最新版本 (v{version})！",
		"notifications.updateAvailable": "Lyrics Plus v{version} 现已发布！点击进行更新",
		"notifications.installCommandCopied": "已复制安装命令！请粘贴至PowerShell",
		"notifications.updateSkipped": "已跳过更新",
