...
const TranslationMenu = react.memo(({ friendlyLanguage, hasTranslation }) => {
	...
	}, [friendlyLanguage, CONFIG.visual["translate:translated-lyrics-source"], items]);
					...
					menu: react.createElement(
						...
						react.createElement(OptionList, {
							...
							onChange: (name, value) => {
								...
								// Force re-process when display mode changes
								if (name.startsWith("translation-mode:")) {
									if (window.lyricContainer) {
										// Force a re-render and re-process
				...
				Spicetify.ReactComponent.ContextMenu,
				{
					menu: react.createElement(
						...
						react.createElement(OptionList, {
							...
							onChange: (name, value) => {
								// Debounce to avoid rapid state changes from continuous slider dragging.
								...
								timeout = setTimeout(() => {
									...
									// Force re-process if a translation mode is changed
